---
title: "Development of iron status in the PNC and associations with cognitive performance and white matter integrity."
author: "Bart Larsen"
date: "5/09/2022"
output:
  html_document:
...
# Sample description and analysis results.  
Below is the output of the data organization, sample curation, and analysis code for this project. To see the step-by-step instructions and the code itself, please view the rmarkdown file, `IronStatus_AnalysisCode.Rmd` [in the repository](https://github.com/PennLINC/IronStatus_Development).  
